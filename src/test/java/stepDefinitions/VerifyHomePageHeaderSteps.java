...
//                Assert.assertTrue(homePageHeader.isDisplayed_eleganDecorsNameAndLogo());
                sa.assertTrue(homePageHeader.isDisplayed_eleganDecorsNameAndLogo());
